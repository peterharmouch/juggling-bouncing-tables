function [q1, q2, q3] = inv_kin_interpol(z, tx, ty, lookup_table)
%%
...
q1 = griddata(Z, theta_x, theta_y, qA, z, tx, ty);
q2 = griddata(Z, theta_x, theta_y, qB, z, tx, ty);
q3 = griddata(Z, theta_x, theta_y, qC, z, tx, ty);
