...
%%
    ...
    if draw > 0
        if show_referential > 0
        % Plot the x, y, and z axes
        quiver3(0, 0, 0, 5, 0, 0, 'k', 'LineWidth', 2);
        hold on;
        quiver3(0, 0, 0, 0, 5, 0, 'k', 'LineWidth', 2);
        quiver3(0, 0, 0, 0, 0, 5, 'k', 'LineWidth', 2);

        % Add text labels to the ends of each axis arrow
        text(6, 0, 0, 'x', 'Color', 'k', 'FontSize', 14);
        text(0, 6, 0, 'y', 'Color', 'k', 'FontSize', 14);
        text(0, 0, 6, 'z', 'Color', 'k', 'FontSize', 14);
        end
